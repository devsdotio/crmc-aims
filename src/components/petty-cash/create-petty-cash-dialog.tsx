  ...
  const handleSelectPO = (po: GroupedPurchaseOrder) => {
    ...
    const items =
      formattedList.length > 0
        ? formattedList
        : [`Petty Cash Disbursement for Purchase Order #${po.poNumber}`];
                  ...
                  <div>
                    ...
                    {particularsMode === "paragraph" ? (
                      <textarea
                        ...
                        placeholder="Specify what items/expenses are covered by the petty cash funds..."
                          ...
                          {listItems.map((item, idx) => (
                            <div key={idx} className="flex items-center gap-2">
                              ...
                              <input
                                ...
                                placeholder={`Item or expense #${idx + 1}...`}
